...
export function buildSystemPrompt(session: CallSession): string {
  ...
  return [
    ...
    "- VERIFY_PATIENT gates GET_NEXT_APPOINTMENT, BOOK_APPOINTMENT, and CONFIRM_APPOINTMENT. If booking verification finds no record, continue new-patient collection without asking whether the caller is new. For next-appointment or confirmation no-match, follow the staff handoff.",
